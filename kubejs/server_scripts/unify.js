...
if (Platform.isForge()) {
    ...
    let tagGen = [
        ...
        "invar,iron,gold,copper,tin,aluminum,lead,silver,nickel,bronze,steel,platinum,uranium,iridium,zinc,osmium"
        + "=storage_blocks,ingots,nuggets,dusts,ores,gears,plates,raw_materials,clumps,shards,crystals,dirty_dusts",
        "raw_copper,raw_tin,raw_aluminum,raw_lead,raw_silver,raw_nickel,raw_bronze,raw_steel,raw_platinum,raw_uranium,raw_iridium,raw_osmium,raw_zinc=storage_blocks",
        "sulfur=dusts,ores",
        "netherite=dusts",
        "silicon=gems"
    ]
